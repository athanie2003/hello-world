...
class FinalBoss:
    def gameLoop(called):
        ...
        #SFX
        explosion_sound = pygame.mixer.Sound('asteroid-explosion.wav')
        explosion_sound.set_volume(1.5)
        boss_hit_sound = pygame.mixer.Sound('boss-hit.wav')
        boss_hit_sound.set_volume(0.5)
        boss_shoot_sound = pygame.mixer.Sound('boss-shoot.wav')
        boss_shoot_sound.set_volume(1.5)
        player_shoot_sound = pygame.mixer.Sound('player-shoot.wav')
        player_shoot_sound.set_volume(0.5)
        player_hit_sound = pygame.mixer.Sound('player-hit.wav')
        ...
        while running:
            ...
            if player_health == 0:
                running = False
                #print('GAME OVER')
                LoseScreen.lScreenLoop(called = True)
            ...
            if boss_health == 0:
                running = False
                #print('YOU WIN')
                VictoryScreen.vScreenLoop(called = True)
