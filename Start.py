...
class Start:
    ...
    def menuLoop(called):
        ...
        bgImg = pygame.image.load('title-screen.png')
        ...
        startBtn = Button(screen, color_light, color_dark, button_x, button_y, button_width, button_height, 'Start', color, 'FORCED SQUARE.ttf', 35)
